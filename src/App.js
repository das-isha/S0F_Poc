  ...
  render() {
    return (
      <Sider
        ...
        width="230"
        style={{
          background: '#FFCCCC', // Set the background to red
...
class App extends React.Component {
  ...
  render() {
    ...
    const basename =
      window.location.hostname == "cvshealth.github.io"
                ...
                >
                  <div style={{ display: 'inline-flex', alignItems: 'center', marginLeft: "20px" }}>
                    <div style={{ marginRight: 10, textAlign: 'right' }}>
                      <p style={{ margin: 0, marginBottom: '2px', lineHeight: '1', fontWeight: 'bold' }}>Dr. Caren Strosin</p>
                      <p style={{ margin: 0, lineHeight: '1' }}>Primary Care Physician</p>
                    </div>
                    <Avatar
                      src={profile}
                      size={80} // Adjust the size here. The number represents pixels.
                    />
                    {!this.context.isMobile && <CaretDownOutlined style={{ marginLeft: '5px' }} />}
                  </div>
                </Popconfirm>
              </div>
            </Header>
...
const FhirFooter = () => {
  return (
    <Footer style={{ textAlign: "center" }} className="footer">
      Health Dashboard 2023 Created by <a href="CVS Health">CVS Health</a>
